...
→ Adjust tone/speed for character
```

### Phase 4: Animation (2-4 hours)
```bash
# Create talking head videos
SadTalker (via notebook)
→ TikTok script + character image → talking video
→ LinkedIn post + script → presentation video
→ Blog article excerpt + script → teaser video
```
...
- **Arena setup:** This file (AI-INFLUENCER-ARSENAL.md)
...
- **AI-Influencer-Generator:** `/tmp/ai-influencer/AI_Influencer.ipynb` (Jupyter notebook)
- **Persona inventory:** Create `AI-INFLUENCER-PERSONAS.csv` (your persona definitions)

## Commands Quick Reference

```bash
# Start trend intelligence
/follow-builders
...
# Generate content
/affiliate-skills → say "Write viral post about AI video tools"

# Research and sources
/affiliate-skills → say "Collect sources on HeyGen and pricing"

# Plan full funnel
/affiliate-skills → say "Plan my 5-week content funnel for AI video niche"
```
