...
const MODELS_URL = process.env.ZENMUX_MODELS_URL || "https://zenmux.ai/api/v1/models";
...
server.registerTool(
  "gemini_list_models",
  {
    ...
    description:
      ...
      "GET /models). Use this to discover valid `model` slugs — e.g. Gemini ids — before " +
      "calling gemini_generate, gemini_chat, or gemini_image.",
    inputSchema: {
      filter: z
        .string()
        .optional()
