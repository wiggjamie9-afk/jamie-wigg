...
2. **Polymarket's AI screenshot** — Unexpected high-value feature; build it first, monetize later
3. **Anthropic's enterprise model** — 70-75% revenue from API; focus on B2B
4. **Turbo-OCR batch processing** — Offline, no real-time requirement; batch > streaming for cost/throughput
5. **GLM-5.1's task persistence** — 8-hour continuous work; Mary should sustain campaign generation across sessions
