...
const DEFAULTS: AgentConfig = {
  apiKey: '',
  // Latest-alias: always resolves to the newest Anthropic flagship, no redeploy.
...
export function loadConfig(overrides: Partial<AgentConfig> = {}): AgentConfig {
  ...
  if (!config.apiKey) throw new Error('OPENROUTER_API_KEY is required. Copy .env.example to .env or export it.');
  return config;
}
