...
- [x] **T5** — Write pilot script (three-act, 8–12 min)
  ...
  - ✓ Delivered: 12:47 screenplay; 5-act (freedom→dread→classroom→shame→fantasy→snap back→recognition); Mrs. Henderson's moment as emotional anchor
...
- [x] **T7** — Create character design + expression sheets
