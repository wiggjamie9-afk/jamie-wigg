...
Routines draw down subscription usage limits in the same way as interactive sessions. In addition, routines have daily limits:

- **Pro:** up to 5 routines per day
- **Max:** up to 15 routines per day
- **Team and Enterprise:** up to 25 routines per day

You can run extra routines beyond these limits with extra usage. See the docs for more information.
